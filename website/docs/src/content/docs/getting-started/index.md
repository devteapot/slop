...
Install the [SLOP browser extension](/extension/install). It discovers your provider automatically and shows the live tree in a sidebar. You can chat with the AI and watch it read state and invoke actions.
