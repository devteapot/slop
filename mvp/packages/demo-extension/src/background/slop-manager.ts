import type { SlopNode, PatchOp, ResultMessage } from "../shared/types";
import type { BackgroundMessage, ContentMessage } from "../shared/messages";
import type { ChatMessage } from "../shared/tools";
import { SlopConsumer } from "../shared/consumer";
import { WebSocketClientTransport } from "../shared/transport-ws";
import { PostMessageClientTransport } from "../shared/transport-pm";
import { affordancesToTools, formatTree, decodeTool } from "../shared/tools";
