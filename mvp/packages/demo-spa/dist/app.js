...
// node_modules/.bun/react-dom@19.2.4+b1ab299f0a400331/node_modules/react-dom/cjs/react-dom-client.development.js
...
// node_modules/.bun/react-dom@19.2.4+b1ab299f0a400331/node_modules/react-dom/client.js
...
// packages/demo-spa/src/main.tsx
var import_client = __toESM(require_client(), 1);

// packages/demo-spa/src/App.tsx
var import_react2 = __toESM(require_react(), 1);

// packages/demo-spa/src/use-slop.ts
var import_react = __toESM(require_react(), 1);

// packages/demo-spa/src/slop-provider.ts
class BrowserSlopProvider {
  tree = { id: "root", type: "root" };
  version = 0;
...
// packages/demo-spa/src/use-slop.ts
function useSlop({ id, name, tree, handlers }) {
...
var nextId = 5;
function buildTree(notes, folders, activeFolder) {
  return {
    id: "root",
    type: "root",
...
function App() {
  const [notes, setNotes] = import_react2.useState(INITIAL_NOTES);
  const [folders, setFolders] = import_react2.useState(INITIAL_FOLDERS);
  const [activeFolder, setActiveFolder] = import_react2.useState(null);
  const [editingNote, setEditingNote] = import_react2.useState(null);
  const [showNewNote, setShowNewNote] = import_react2.useState(false);
  useSlop({
    id: "notes-app",
    name: "Notes App",
    ...
    handlers: {
      create_note: (params) => {
        const note = {
          ...
          folder: params.folder ?? folders[0]?.id ?? "personal",
          pinned: false,
      ...
      move_note: (params, path) => {
        const id = path.split("/").pop();
        setNotes((prev) => prev.map((n) => n.id === id ? { ...n, folder: params.folder } : n));
      },
      delete_note: (_, path) => {
        const id = path.split("/").pop();
  ...
  const addNote = import_react2.useCallback((title, content) => {
    const note = {
      id: `note-${nextId++}`,
      title,
      content,
    ...
    children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("nav", {
            children: [
              ...
              folders.map((f) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
                    className: "count",
                    children: notes.filter((n) => n.folder === f.id).length
                  }, undefined, false, undefined, this)
                ]
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("main", {
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("header", {
            children: [
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h2", {
                children: activeFolder ? folders.find((f) => f.id === activeFolder)?.name ?? "Notes" : "All Notes"
              }, undefined, false, undefined, this),
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
          ...
          showNewNote && /* @__PURE__ */ jsx_dev_runtime.jsxDEV(NewNoteForm, {
            onSubmit: addNote,
          ...
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: [
              sortedNotes.map((note) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV(NoteCard, {
                note,
              ...
              }, note.id, false, undefined, this)),
              sortedNotes.length === 0 && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
                className: "empty",
                children: "No notes yet. Create one!"
              }, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this)
        ]
...
function NoteCard({ note, folder, isEditing, onEdit, onSave, onCancel, onPin, onDelete }) {
  const [title, setTitle] = import_react2.useState(note.title);
  const [content, setContent] = import_react2.useState(note.content);
  if (isEditing) {
    return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          folder && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
            className: "folder-tag",
            style: { background: folder.color + "33", color: folder.color },
            children: folder.name
          }, undefined, false, undefined, this),
          note.pinned && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
            className: "pin-icon",
            title: "Pinned",
            children: "★"
          }, undefined, false, undefined, this)
...
import_client.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsx_dev_runtime2.jsxDEV(App, {}, undefined, false, undefined, this));
