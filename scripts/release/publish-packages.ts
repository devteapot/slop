import { getStableReleaseVersion, getTypeScriptPackages, runCommand, sortPackagesForPublish } from "./shared";
...
for (const pkg of packages) {
  ...
  if (process.env.NPM_TAG) {
    publishArgs.push("--tag", process.env.NPM_TAG);
  }

  runCommand("bun", publishArgs, pkg.dir);
}
